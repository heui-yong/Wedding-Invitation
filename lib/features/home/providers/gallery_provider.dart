...
final galleryImageListProvider = Provider<List<GalleryModel>>((ref) {
  return [
    ...
    GalleryModel(id: "2", assetPath: AppImagePath.gallery2Path, isVertical: false),
    GalleryModel(id: "3", assetPath: AppImagePath.gallery3Path, isVertical: false),
    GalleryModel(id: "4", assetPath: AppImagePath.gallery4Path, isVertical: false),
    GalleryModel(id: "5", assetPath: AppImagePath.gallery5Path, isVertical: false),
    ...
    GalleryModel(id: "9", assetPath: AppImagePath.gallery9Path, isVertical: false),
    ...
    GalleryModel(id: "16", assetPath: AppImagePath.gallery16Path, isVertical: false),
    ...
    GalleryModel(id: "19", assetPath: AppImagePath.gallery19Path, isVertical: false),
  ];
});
